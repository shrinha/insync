          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <blockquote className="text-muted-foreground mb-6">
                "Insync transformed how we coordinate meetings across our global team. The timezone
                handling is flawless and booking is effortless."
              </blockquote>
              <div className="flex items-center">
            ...
            >
              ...
              <blockquote className="text-muted-foreground mb-6">
                "We reduced our scheduling overhead by 80%. The smart booking links eliminate the
                back-and-forth emails completely."
              </blockquote>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-muted rounded-full mr-4 flex items-center justify-center">
            ...
            >
              ...
              <blockquote className="text-muted-foreground mb-6">
                "The calendar integrations are seamless. Our clients love how easy it is to book
                consultations, and we never double-book anymore."
              </blockquote>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-muted rounded-full mr-4 flex items-center justify-center">
